;;; keys.clj --- keyboard keys -*- mode: clojure -*-

(ns hkdb.keys.core
  "keys are the atomic element of a keymap."
...
;; (defn chord [& keys]
;;   (let [keycode (some keycodes keys)
;;         mask    (reduce bit-or 0 (keep mods/modifiers keys))]
;;     (pack keycode mask)))


;; (defn new-keycord
;;   "Create a keychord based on keys pressed at the same time."
;;   [& keys]
;;   (println "Create a new keychord"))
